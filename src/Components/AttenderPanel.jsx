...
const Sidebar = ({ activePage, setActivePage }) => (
  <div className="d-flex flex-column p-3">
    ...
    <ul className="nav nav-pills flex-column mt-2 mb-auto gap-2">
      <li
        className={`my-sidebarhr ${activePage === "attenderDashboard" ? "selected" : ""}`}
        onClick={() => setActivePage("attenderDashboard")}
      >
        <Link to="attenderDashboard" className="btn nav-link text-dark text-start">
      ...
      <li
        className={`my-sidebarhr ${activePage === "attenderVaccinations" ? "selected" : ""}`}
        onClick={() => setActivePage("attenderVaccinations")}
      >
        <Link to="attenderVaccinations" className="btn nav-link text-dark text-start">
