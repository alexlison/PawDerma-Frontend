...
const ViewAttenderSchedules = () => {
  ...
  const fetchData = () => {
    axios
      .post(
        "http://localhost:4000/viewAttenderSchedules",
        { attenderId: userId },
            ...
            <table className="table my-table small-table table-sm table-striped align-middle text-center">
              <thead className="table-light">
                <tr>
                  ...
                  <th scope="col">Day</th>
                  <th scope="col">Vaccination From</th>
                  <th scope="col">Vaccination To</th>
...
export default ViewAttenderSchedules;
